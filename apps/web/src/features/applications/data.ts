      ...
      if (existingCandidate?.deletedAt) {
        const [restored] = await tx
          ...
          .set({
            ...
            countryCode: values.countryCode ?? existingCandidate.countryCode,
            region: values.region ?? existingCandidate.region,
            city: values.city ?? existingCandidate.city,
            timezone: values.timezone ?? existingCandidate.timezone,
